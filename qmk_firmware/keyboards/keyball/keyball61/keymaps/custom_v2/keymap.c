...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [base] = LAYOUT_universal(
    ...
    G(KC_TAB)     , OSM(MOD_MEH) , OSM(MOD_LALT)  , OSM(MOD_LGUI) , OSM(MOD_LCTL) , KC_SPC  , LAG(KC_LCTL),   KC_BSPC , LT(nav,KC_ENT) , xxx  , KC_NO    , KC_NO    , TO(base)  , TO(media)
  ),
  ...
  [mouse] = LAYOUT_universal(
    xxx  , xxx     , LSG(KC_2) , xxx     , LSG(KC_2) , xxx  ,                             KBC_RST  , KBC_SAVE   , xxx        , xxx       , xxx        , xxx     ,
    ...
    ___  , xxx     , G(KC_X)   , G(KC_C) , G(KC_V)   , xxx  , xxx      ,           xxx  , xxx      , KC_BTN1    , KC_BTN2    , KC_BTN3   , xxx        , xxx     ,
