...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [base] = LAYOUT_universal(
    ...
    OSM(MOD_LSHT) , KC_Z      , KC_X           , KC_C          , KC_V          , KC_B           , KC_RBRC          ,       KC_RBRC          , KC_N    , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH     , KC_PIPE  ,
  ...
  [nav] = LAYOUT_universal(
    ...
    KC_NO    , KC_NO    , KC_NO    , KC_NO    , KC_NO    , KC_NO    , KC_NO    ,           KC_NO    , KC_NO    , _______  , KC_NO    , KC_NO    , KC_NO    , KC_NO
  ),
